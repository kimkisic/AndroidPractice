package com.mrhi.ex64servicebindtest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(musicService==null){
            ...
            startService(intent);//Service객체가 없다면 create를 하고 onStartCommand()메소드를 호출하며, 있다면 onStartCommand()만 실행함.

            //서비스객체의 참조값을 얻어오기 위해
            //서비스객체와 연결(bind)하는 메소드를 호출
            bindService(intent, conn, 0);//flags:0 일때, bind할 때 서비스객체를 자동 만들지 않음.
        }
    }
