...
class SecondActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items.add( Item("robin", "Nice Kotlin.", R.drawable.moana02) )
        items.add( Item("tom", "Good Kotlin.", R.drawable.moana03) )
        items.add( Item("lee", "aaa Kotlin.", R.drawable.moana04) )
        items.add( Item("hong", "ddd Kotlin.", R.drawable.moana05) )
