package com.mrhi.ex78httprequesttest;
    ...
    public void clickGet(View view) {
        ...
        new Thread(){
            ...
            public void run() {
                ...
                //Get방식을 데이터를 보낼 서버주소
                String serverUrl="http://mrhi2018.dothome.co.kr/Android/getTest.php";

                //Get방식은 보낼데이터(name, msg)를 URL뒤에 붙여서 보내는 방식
                //한글은 인터넷 URL에 사용 불가!! 그래서 한글을 utf-8 인코딩
                try {
    ...
    public void clickPost(View view) {
        ...
        new Thread(){
            ...
            public void run() {
                ...
                String serverUrl="http://mrhi2018.dothome.co.kr/Android/postTest.php";
